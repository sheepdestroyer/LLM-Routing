...
def test_parse_oauth_token_info_flat():
    data = {"access_token": "ya29.flat_token", "expiry_date": 1786715124000}
    token, expiry_ms = main._parse_oauth_token_info(data)
...
def test_parse_oauth_token_info_iso_utc():
    data = {"access_token": "ya29.utc_token", "expiry": "2026-08-14T13:45:24Z"}
    token, expiry_ms = main._parse_oauth_token_info(data)
...
def test_parse_oauth_token_info_iso_negative_tz():
    data = {"access_token": "ya29.neg_tz_token", "expiry": "2026-08-14T08:45:24.123456-05:00"}
    token, expiry_ms = main._parse_oauth_token_info(data)
...
def test_parse_oauth_token_info_invalid_date_str():
    data = {"access_token": "ya29.invalid_date", "expiry": "not-a-valid-date"}
    token, expiry_ms = main._parse_oauth_token_info(data)
