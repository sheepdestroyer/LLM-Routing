...
LANGFUSE_MANAGED_MODELS = [
    (
        ...
        "locallama-qwen",
        "(?i)^(openai/)?(locallama-qwen|local-qwen)$",
        "TOKENS",
        0.0,
        0.0,
        0.0,
    ...
    (
        ...
        "locallama-qwen-hass",
        "(?i)^(openai/)?(locallama-qwen-hass|local-qwen-hass)$",
        "TOKENS",
        0.0,
        0.0,
        0.0,
    ...
    (
        ...
        "(?i)^(openai/)?(locallama-qwen-routing|local-qwen-routing)$",
        "TOKENS",
        0.0,
        0.0,
        0.0,
    ...
    (
        "locallama-qwen-vl-model-def",
        "locallama-qwen-vl",
        r"(?i)^(openai/)?(locallama-qwen-vl|local-qwen-vl)$",
        "TOKENS",
        0.0,
        0.0,
        0.0,
...
async def chat_completions(request: Request):
    ...
    try:
        ...
        if client_model in AUTO_MODELS or client_model == "llm-routing-ollama":
            ...
            # Direct routing: client requested a specific model (DB model, alias, or tier), forward directly to LiteLLM
            target_model = client_model
            triage_latency = 0.0
            was_cache_hit = False
