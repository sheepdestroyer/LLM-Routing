...
def test_resolve_with_valid_base_request():
    ...
    req = MockRequest(
        base_host="sub.vendeuvre.lan", base_netloc="sub.vendeuvre.lan:8000", url_scheme="https", url_netloc="[::1]:8000"
    )
...
def test_local_fallback_ipv6():
    ...
    req = MockRequest(base_host="::1", base_netloc="[::1]:8000", url_scheme="http", url_netloc="[::1]:8000")
...
def test_local_fallback_ipv4():
    ...
    req = MockRequest(
        base_host="127.0.0.1", base_netloc="127.0.0.1:8000", url_scheme="http", url_netloc="127.0.0.1:8000"
    )
