...
| `llm-routing-auto-agy` | ✅ | agy (gated: reasoning → gemini-3.5-flash, advanced → gemini-3.5-flash → claude-opus-3.5) | LiteLLM with classified tier | 262K |
...
Tier 2: CASCADE_DEFAULT_MODEL_OVERRIDE=      
        claude-opus-3-5@default               → Claude Opus 4.6 (Premium Anthropic Tier)
...
CASCADE_DEFAULT_MODEL_OVERRIDE=claude-opus-3-5@default agy --print "Hello"
