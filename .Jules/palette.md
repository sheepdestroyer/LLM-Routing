...
## 2024-08-24 - Interactive Elements Accessibility
**Learning:** When using interactive elements for actions like clearing data or saving notes without navigating, using `<a href="#">` tags causes unintended scroll jumps.
**Action:** Use semantically correct `<button type="button">` elements with inline CSS resets to match the original visual style without causing page jumps.
