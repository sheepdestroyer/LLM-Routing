...
## 2023-10-24 - Explicit Empty States in List/Detail Layouts
**Learning:** Empty collections or null selections in dynamic JS list/detail layouts leave users confused as to whether data failed to load or if a filter simply returned no results.
